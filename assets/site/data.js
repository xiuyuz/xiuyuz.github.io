...
export const data = {
  ...
  papers: [
    ...
    },
    {
      ...
      authors:
        "Khoa L. A. Huynh, Bruno F. Matuck, Deiziane Souza, XiuYu Zhang, Giancarlo Fatobene, Luiz Alberto Valente Soares Junior, Luiz Fernando Silva, Vanderson Geraldo Rocha, Kevin M. Byrd, Jinze Liu",
      year: "2025",
      ...
      image: "",
      summary:
        "STARComm identifies spatial patterns of intercellular signaling from two- and three-dimensional transcriptomic data by grouping co-located ligand-receptor activity into multicellular communication modules.",
      code: "",
    },
    {
    ...
    },
    {
      ...
      summary:
        "Digital Twin (DT) technologies create digital models of physical entities frequently in multimedia forms, which are crucial for concurrent simulation and analysis of real-world systems.",
      code: "",
    },
    {
      key: "pcpp_preprint",
  ...
  aboutPersonalHtml:
    '<p>Hi! I’m a first-year Computer Science Ph.D. student in the <a href="https://www.nextcenter.org/">NExT++ Research Centre</a> at the <a href="https://www.comp.nus.edu.sg/">National University of Singapore</a>, co-advised by <a href="https://www.comp.nus.edu.sg/~liangzk/">Prof. Zhenkai Liang</a> and <a href="https://www.chuatatseng.com/">Prof. Tat-Seng Chua</a>. I am also a member of the <a href="https://curiosity.comp.nus.edu.sg/">CuriOSity Research Group</a>. I’m broadly interested in developing effective, robust, and safe AI systems that can understand, reason about, and interact with the world in ways inspired by human intelligence, across language, vision, and potentially other modalities. Before pursuing my Ph.D., I received my Master’s degree in Electrical Engineering and Computer Science from the <a href="https://eecs.berkeley.edu/">University of California, Berkeley</a> and my Honours Bachelor’s degree in Computer Science from the <a href="https://web.cs.toronto.edu/">University of Toronto</a>.</p><p class="ct-collaboration"><strong>I’m open to new collaborations.</strong> If you’re interested in my research or would like to work together, please feel free to <button class="ct-contact-trigger" type="button" data-contact-open>get in touch</button>.</p>',
  aboutResearchHtml:
    "<p>My recent research focuses on reasoning in AI systems, with an emphasis on understanding how reasoning and abstraction arise from learned representations, and how these processes can be made more reliable, verifiable, and safe. I am particularly interested in approaches that improve the correctness and trustworthiness of AI behavior while maintaining strong performance. More broadly, my research interests include:</p><ol><li>Understanding how different modalities contribute to learning, knowledge representation and reasoning in AI systems</li><li>Developing robust methods for knowledge extraction and verification across modalities</li><li>Building integrated AI systems that can coordinate multiple capabilities to solve complex tasks safely and effectively</li></ol>",
};
